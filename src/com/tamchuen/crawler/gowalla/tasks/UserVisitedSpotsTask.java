...
/**
 * Get User Spot relationship information from user's visited spots.
 * @author Dequan
 *
 */
public class UserVisitedSpotsTask extends GowallaTask {
	public static final String NAME = "UserVisitedSpotsTask";
	private static final Logger logger = Logger.getLogger(NAME);
	private static int POLL_INTERVAL = 5000;

	public UserVisitedSpotsTask() {
		this.setName( NAME );
	}
	...
	public boolean start(){
		...
		new Thread(NAME + ".background")
		{
			...
			public void run()
			{
				...
				// loop
				while ( (id = taskIdQueue.poll()) != null && TaskStatus.STARTED.equals( UserVisitedSpotsTask.this.getStatus()) )
				{
					long start = System.currentTimeMillis();
					long userId = Long.valueOf(id);
					currentId = id;

					String apiUrl = GOWALLA_USERS_URL + userId + "/visited_spots_urls";
