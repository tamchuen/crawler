 ...
 * @author  Dequan
 */
abstract class GowallaObject {

	private long id;

	public GowallaObject(){
		this.id = -1L;
	}
	public long getId() {
		return id;
	 ...
	 * @return
	 */
	public static String getTableName(long id, String table, int noOfTables){
		if( noOfTables <=1 ){
			return table;
		}
	 ...
	 *	}
	 *] or "founders": []
	 *	We need to get the list of id like 156 from it, parameters are rs,"founders", "url", "/users/"
